...
module.exports = {
    ...
    OWNER_ID: process.env.OWNER_ID || "631102214076891157", //your owner discord id example: "515490955801919488"
    ...
    LANGUAGE: {
      defaultLocale: process.env.LANGUAGE || "th", // "en" = default language
